...
$('#button-upload').on('click', function() {
	...
	$('body').prepend('<form enctype="multipart/form-data" id="form-upload" accept="image/*" multiple="multiple" style="display: none;"><input type="file" name="file" value="" /></form>');
